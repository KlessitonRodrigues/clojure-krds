...
var taoensso$sente$interfaces$IServerChan$sch_open_QMARK_$dyn_23771 = (function (sch){
...
return taoensso$sente$interfaces$IServerChan$sch_open_QMARK_$dyn_23771(sch);
}
});

var taoensso$sente$interfaces$IServerChan$sch_close_BANG_$dyn_23775 = (function (sch){
var x__5393__auto__ = (((sch == null))?null:sch);
...
return taoensso$sente$interfaces$IServerChan$sch_close_BANG_$dyn_23775(sch);
}
});

var taoensso$sente$interfaces$IServerChan$sch_send_BANG_$dyn_23776 = (function (sch,websocket_QMARK_,msg){
var x__5393__auto__ = (((sch == null))?null:sch);
...
return taoensso$sente$interfaces$IServerChan$sch_send_BANG_$dyn_23776(sch,websocket_QMARK_,msg);
}
});
...
var taoensso$sente$interfaces$IServerChanAdapter$ring_req__GT_server_ch_resp$dyn_23777 = (function (sch_adapter,ring_req,callbacks_map){
...
return taoensso$sente$interfaces$IServerChanAdapter$ring_req__GT_server_ch_resp$dyn_23777(sch_adapter,ring_req,callbacks_map);
}
});
...
var taoensso$sente$interfaces$IPacker$pack$dyn_23778 = (function (_,x){
...
return taoensso$sente$interfaces$IPacker$pack$dyn_23778(_,x);
}
});

var taoensso$sente$interfaces$IPacker$unpack$dyn_23780 = (function (_,x){
var x__5393__auto__ = (((_ == null))?null:_);
...
return taoensso$sente$interfaces$IPacker$unpack$dyn_23780(_,x);
}
});

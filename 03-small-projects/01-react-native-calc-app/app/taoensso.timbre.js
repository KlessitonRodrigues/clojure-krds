...
var no_stacktrace_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24954__$1,new cljs.core.Keyword(null,"no-stacktrace?","no-stacktrace?",1701072694));
var stacktrace_fonts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24954__$1,new cljs.core.Keyword(null,"stacktrace-fonts","stacktrace-fonts",830799382));
var map__24955 = data;
var map__24955__$1 = cljs.core.__destructure_map(map__24955);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24955__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24955__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var msg_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24955__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24955__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24955__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var hostname_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24955__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var timestamp_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24955__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24955__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
...
var len__5769__auto___25050 = arguments.length;
var i__5770__auto___25051 = (0);
while(true){
if((i__5770__auto___25051 < len__5769__auto___25050)){
args__5775__auto__.push((arguments[i__5770__auto___25051]));

var G__25052 = (i__5770__auto___25051 + (1));
i__5770__auto___25051 = G__25052;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.swap_config_BANG_.cljs$lang$applyTo = (function (seq24958){
...
return ((function (){var G__24967 = taoensso.timbre.valid_level(x);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__24967) : taoensso.timbre._levels_map.call(null,G__24967));
})() >= (function (){var G__24972 = taoensso.timbre.valid_level(y);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__24972) : taoensso.timbre._levels_map.call(null,G__24972));
})());
});
...
var fexpr__24976 = taoensso.timbre._compile_ns_filter(whitelist,blacklist);
return (fexpr__24976.cljs$core$IFn$_invoke$arity$1 ? fexpr__24976.cljs$core$IFn$_invoke$arity$1(_QMARK_ns) : fexpr__24976.call(null,_QMARK_ns));
}));
/**
...
var vec__24988 = vargs;
var v0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24988,(0),null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__24992 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24992,(0),null);
return v0__$1;
})():null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__24996 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24996,(0),null);
return v0__$1;
})():null);
var vargs__$2 = (cljs.core.truth_(fmt_msg_QMARK_)?taoensso.timbre.vrest(vargs__$1):vargs__$1);
...
var instant_25061 = taoensso.encore.now_dt();
var context_25062 = taoensso.timbre._STAR_context_STAR_;
var vargs_25063 = cljs.core.deref(vargs_);
var vec__25006_25064 = taoensso.timbre.parse_vargs(_QMARK_err,msg_type,vargs_25063);
var _QMARK_err_25065__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25006_25064,(0),null);
var _QMARK_meta_25066 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25006_25064,(1),null);
var _QMARK_msg_fmt_25067 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25006_25064,(2),null);
var vargs_25068__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25006_25064,(3),null);
var data_25069 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__5045__auto__ = _QMARK_base_data;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"vargs","vargs",-966597273),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"?err","?err",549653299),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?err_","?err_",789480858),new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891)],[instant_25061,config,vargs_25068__$1,_QMARK_file,(function (){var fexpr__25011 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null);
return (fexpr__25011.cljs$core$IFn$_invoke$arity$1 ? fexpr__25011.cljs$core$IFn$_invoke$arity$1(level) : fexpr__25011.call(null,level));
})(),_QMARK_ns_str,level,_QMARK_err_25065__$1,context_25062,_QMARK_line,(new cljs.core.Delay((function (){
return _QMARK_err_25065__$1;
}),null)),_QMARK_meta_25066,_QMARK_msg_fmt_25067]));
var _QMARK_data_25070 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,mf){
...
}),data_25069,new cljs.core.Keyword(null,"middleware","middleware",1462115504).cljs$core$IFn$_invoke$arity$1(config));
var temp__5804__auto___25074 = _QMARK_data_25070;
if(cljs.core.truth_(temp__5804__auto___25074)){
var data_25076__$1 = temp__5804__auto___25074;
var map__25016_25077 = data_25076__$1;
var map__25016_25078__$1 = cljs.core.__destructure_map(map__25016_25077);
var vargs_25079__$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25016_25078__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var data_25080__$2 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data_25076__$1,new cljs.core.Keyword(null,"vargs_","vargs_",552132148),(new cljs.core.Delay((function (){
return vargs_25079__$2;
}),null)));
var data_25081__$3 = taoensso.encore.assoc_nx.cljs$core$IFn$_invoke$arity$variadic(data_25080__$2,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),(new cljs.core.Delay((function (){
var G__25021 = msg_type;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__25021)){
return "";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"p","p",151049309),G__25021)){
return taoensso.timbre.str_join(vargs_25079__$2);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),G__25021)){
if(typeof _QMARK_msg_fmt_25067 === 'string'){
} else {
...
return taoensso.encore.format_STAR_(_QMARK_msg_fmt_25067,vargs_25079__$2);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25021)].join('')));
...
return cljs.core.hash(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [callsite_id,_QMARK_msg_fmt_25067,cljs.core.get.cljs$core$IFn$_invoke$arity$3(_QMARK_meta_25066,new cljs.core.Keyword(null,"hash","hash",-13781596),vargs_25079__$2)], null));
}),null))], 0));
var output_fn1_25082 = taoensso.encore.memoize_(cljs.core.get.cljs$core$IFn$_invoke$arity$3(config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
...
return cljs.core.not((function (){var G__25028 = cljs.core.force(new cljs.core.Keyword(null,"hash_","hash_",-827203612).cljs$core$IFn$_invoke$arity$1(data_25081__$3));
return (rl_fn.cljs$core$IFn$_invoke$arity$1 ? rl_fn.cljs$core$IFn$_invoke$arity$1(G__25028) : rl_fn.call(null,G__25028));
})());
}
})();
if(rate_limit_okay_QMARK_){
var map__25029 = appender;
var map__25029__$1 = cljs.core.__destructure_map(map__25029);
var apfn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25029__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25029__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
...
/** @this {Function} */
(taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq25048){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq25048));
}));

...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12052 = c;
var G__12052__$1 = (((G__12052 == null))?null:G__12052.prototype);
if((G__12052__$1 == null)){
return null;
} else {
return G__12052__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12061 = c;
...
var or__5045__auto__ = (function (){var G__12082 = c;
var G__12082__$1 = (((G__12082 == null))?null:G__12082.constructor);
if((G__12082__$1 == null)){
return null;
} else {
return G__12082__$1.displayName;
}
})();
...
var G__12084 = c;
var G__12084__$1 = (((G__12084 == null))?null:G__12084.constructor);
if((G__12084__$1 == null)){
return null;
} else {
return G__12084__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__12097 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12098 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12098);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12097);
}});
...
var c = this;
var G__12163_12324 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__12163_12324 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12163_12324);
}
...
var renders_12328 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_12329 = cljs.core.first(cljs.core.vals(renders_12328));
...
if((cljs.core.count(renders_12328) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12328))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12329)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12329], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__12181 = o;
reagent.impl.component.goog$module$goog$object.set(G__12181,cljs.core.name(k),v);
...
return (function() { 
var G__12354__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__12355__i < G__12355__a.length) {G__12355__a[G__12355__i] = arguments[G__12355__i + 0]; ++G__12355__i;}
  args = new cljs.core.IndexedSeq(G__12355__a,0,null);
} 
return G__12354__delegate.call(this,args);};
...
return G__12354__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__12262 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12263 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12263);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12262);
}});
...
var vec__12267 = shadow.js.shim.module$react.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12267,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12267,(1),null);
...
var G__12275 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__12275 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__12275);
}
});
}),[]);

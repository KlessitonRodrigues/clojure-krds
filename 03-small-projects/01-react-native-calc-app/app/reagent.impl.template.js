...
var G__11512 = o;
reagent.impl.template.goog$module$goog$object.set(G__11512,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__11577__delegate = function (args){
...
while (G__11578__i < G__11578__a.length) {G__11578__a[G__11578__i] = arguments[G__11578__i + 0]; ++G__11578__i;}
  args = new cljs.core.IndexedSeq(G__11578__a,0,null);
} 
...
var G__11513 = o;
reagent.impl.template.goog$module$goog$object.set(G__11513,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__11582__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
var G__11514 = props;
var G__11514__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11514,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11514);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11514__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__11515 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11515,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__11515;
}
})(),id_class);
...
var G__11516 = (cljs.core.count(argv) - first_child);
switch (G__11516) {
case (0):
...
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11517,(2),null);
...
var temp__5808__auto___11596 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___11596 == null)){
} else {
var key_11597 = temp__5808__auto___11596;
(jsprops.key = key_11597);
}
...
var temp__5808__auto___11600 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___11600 == null)){
} else {
var key_11601 = temp__5808__auto___11600;
(jsprops.key = key_11601);
}
...
var temp__5808__auto___11606 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___11606 == null)){
} else {
var key_11607 = temp__5808__auto___11606;
(jsprops.key = key_11607);
}
...
var temp__5808__auto___11616 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___11616 == null)){
} else {
var key_11618 = temp__5808__auto___11616;
(jsprops.key = key_11618);
}
...
var temp__5808__auto___11620 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___11620 == null)){
} else {
var key_11622 = temp__5808__auto___11620;
(jsprops.key = key_11622);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11538_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__11538_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__11542 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11542,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11542,(1),null);
...
break;
default:
var G__11630 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__11631 = compiler;
v = G__11630;
compiler = G__11631;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template11561 = (function (opts,id,fn_to_element,parse_fn,meta11562){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template11561.prototype.shadow$build$cljs_hacks$IWithMeta$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template11561.prototype.shadow$build$cljs_hacks$IWithMeta$_with_meta$arity$2 = (function (_11563,meta11562__$1){
var self__ = this;
var _11563__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template11561(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta11562__$1));
}));

(reagent.impl.template.t_reagent$impl$template11561.prototype.shadow$build$cljs_hacks$IMeta$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template11561.prototype.shadow$build$cljs_hacks$IMeta$_meta$arity$1 = (function (_11563){
var self__ = this;
var _11563__$1 = this;
return self__.meta11562;
}));

(reagent.impl.template.t_reagent$impl$template11561.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template11561.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template11561.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template11561.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template11561.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template11561.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta11562","meta11562",-84755633,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template11561.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template11561.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template11561");

(reagent.impl.template.t_reagent$impl$template11561.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template11561");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template11561.
 */
reagent.impl.template.__GT_t_reagent$impl$template11561 = (function reagent$impl$template$__GT_t_reagent$impl$template11561(opts,id,fn_to_element,parse_fn,meta11562){
return (new reagent.impl.template.t_reagent$impl$template11561(opts,id,fn_to_element,parse_fn,meta11562));
});
...
return (new reagent.impl.template.t_reagent$impl$template11561(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});

...
return cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__12560_SHARP_,p2__12559_SHARP_){
if((p2__12559_SHARP_ == null)){
return null;
} else {
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function re_frisk$diff$diff$diff_coll_$_iter__12578(s__12579){
...
var b__12584 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__12583 = (0);
while(true){
if((i__12583 < size__5522__auto__)){
var key = cljs.core._nth(c__5521__auto__,i__12583);
cljs.core.chunk_append(b__12584,(function (){var val_a = cljs.core.get.cljs$core$IFn$_invoke$arity$2(a,key);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12584),re_frisk$diff$diff$diff_coll_$_iter__12578(cljs.core.chunk_rest(s__12579__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12584),null);
}
} else {
var key = cljs.core.first(s__12579__$2);
...
})(),re_frisk$diff$diff$diff_coll_$_iter__12578(cljs.core.rest(s__12579__$2)));
}
} else {
return null;
}

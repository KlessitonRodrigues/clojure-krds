...
var i_16717 = (0);
while(true){
if((i_16717 < arr.length)){
(arr[i_16717] = null);

var G__16722 = (i_16717 + (1));
i_16717 = G__16722;
continue;
} else {
}
...
var i_16732 = (self__.level + (1));
while(true){
if((i_16732 <= (new_level + (1)))){
(update[i_16732] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_16734 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_16734[i]));
} else {
x__$2.forward.push((((i < links_16734.length))?(links_16734[i]):null));
}

if((i < links_16734.length)){
(links_16734[i] = x__$2);
} else {
links_16734.push(x__$2);
}
...
var i_16738 = (0);
while(true){
if((i_16738 <= self__.level)){
var links_16739 = (update[i_16738]).forward;
if((x__$1 === (((i_16738 < links_16739.length))?(links_16739[i_16738]):null))){
(links_16739[i_16738] = (x__$1.forward[i_16738]));

var G__16740 = (i_16738 + (1));
i_16738 = G__16740;
continue;
} else {
var G__16741 = (i_16738 + (1));
i_16738 = G__16741;
continue;
}
} else {
